...
template<class PointT>
void cloudAMinusCloudB(typename pcl::PointCloud<PointT>::Ptr cloudA, typename pcl::PointCloud<PointT>::Ptr cloudB, typename pcl::PointCloud<PointT>::Ptr cloud_out, const float dist_thres);
