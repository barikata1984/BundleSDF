...
template void convert3dOrganizedRGB(cv::Mat &objDepth, cv::Mat &colImage, Eigen::Matrix3f &camIntrinsic, pcl::PointCloud<pcl::PointXYZRGB>::Ptr objCloud);
template void convert3dOrganizedRGB(cv::Mat &objDepth, cv::Mat &colImage, Eigen::Matrix3f &camIntrinsic, pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr objCloud);
...
template<class PointT>
float pointToPlaneICP(typename pcl::PointCloud<PointT>::Ptr src, typename pcl::PointCloud<PointT>::Ptr dst, Eigen::Matrix4f &offsetTransform, int max_iter, float rejection_angle, float max_corres_dist, float score_thres)
{
...
template float pointToPlaneICP<pcl::PointXYZRGBNormal>(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr pclSegment, pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr pclModel, Eigen::Matrix4f &offsetTransform, int max_iter, float rejection_angle, float max_corres_dist, float score_thres);
template float pointToPlaneICP<pcl::PointSurfel>(pcl::PointCloud<pcl::PointSurfel>::Ptr pclSegment, pcl::PointCloud<pcl::PointSurfel>::Ptr pclModel, Eigen::Matrix4f &offsetTransform, int max_iter, float rejection_angle, float max_corres_dist, float score_thres);
...
template void outlierRemovalRadius(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_out, float radius, int min_num);
...
template void downsamplePointCloud<pcl::PointXYZRGBNormal>(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_out, float vox_size);
template void downsamplePointCloud<pcl::PointXYZRGB>(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_out, float vox_size);
template void downsamplePointCloud<pcl::PointXYZ>(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_out, float vox_size);
template void downsamplePointCloud<pcl::PointNormal>(pcl::PointCloud<pcl::PointNormal>::Ptr cloud_in, pcl::PointCloud<pcl::PointNormal>::Ptr cloud_out, float vox_size);
...
template void passFilterPointCloud<pcl::PointXYZRGBNormal>(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_out, const std::string &axis, float min, float max);
template void passFilterPointCloud<pcl::PointXYZRGB>(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_in, pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_out, const std::string &axis, float min, float max);
